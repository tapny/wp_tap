        ...
        <li <?php get_background_image_style(get_post_thumbnail_id()); ?>>
          ...
          <span class="hero-outer">
            <div class="hero-inner">
              ...
              <span class="article-date <?php event_inactive($custom_fields['tf_events_startdate'][0]); ?>" href="event.html">
...
<?php if($custom_fields['tf_events_eventbrite'][0]): ?>
  <section class="eventbrite">
    ...
    <div style="width:100%; text-align:left;" ><iframe  src="https://www.eventbrite.com/tickets-external?eid=<?php echo $custom_fields['tf_events_eventbrite'][0]; ?>&ref=etckt" frameborder="0" height="500" width="100%" vspace="0" hspace="0" marginheight="5" marginwidth="5" scrolling="auto" allowtransparency="true"></iframe><div style="font-family:Helvetica, Arial; font-size:10px; padding:5px 0 5px; margin:2px; width:100%; text-align:left;" ><a style="color:#ddd; text-decoration:none;" target="_blank" href="http://www.eventbrite.com/r/etckt">Sell Tickets</a> <span style="color:#ddd;">through</span> <a style="color:#ddd; text-decoration:none;" target="_blank" href="http://www.eventbrite.com?ref=etckt">Eventbrite</a></div></div>
  </section>
<?php endif; ?>
